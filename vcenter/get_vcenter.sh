...
rm -f datacenters.json
rm -f clusters.json
rm -f datastores.json
rm -f networks.json
...
echo $raw_dcs | tee datacenters.json >/dev/null
...
echo $raw_clusters | tee clusters.json >/dev/null
...
echo $raw_datastore | tee datastores.json >/dev/null
...
echo $raw_networks | tee networks.json >/dev/null